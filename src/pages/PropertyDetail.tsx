        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          ...
          <div className="rounded-2xl overflow-hidden mb-6">
            <div className="aspect-[16/9] bg-muted relative">
              {images.length > 0 ? (
                <img 
                  src={import.meta.VITE_APP_URL + '/uploads/properties/' +images[activeImage]} 
                  alt={property.title} 
              ...
              <div className="flex gap-2 mt-2 overflow-x-auto pb-2">
                {images.map((img, i) => (
                  ...
                  >
                    ...
                    <img src={import.meta.VITE_APP_URL + '/uploads/properties/' +img} alt={`${property.title} - ${i + 1}`} className="w-full h-full object-cover" />
                  </button>
                ))}
              </div>
            )}
